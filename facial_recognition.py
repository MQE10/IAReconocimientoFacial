...
# CONFIG
# ruta = os.getcwd() # ruta de acceso absoluto
path = os.getcwd() +'/' # ruta de acceso
txt_login = "Iniciar Sesión"
txt_register = "Registrarse"
print(path)
sonido_fondo = pygame.mixer.Sound("gmi2.mp3")
sonido_fondo2 = pygame.mixer.Sound("denegado.mp3")
color_white = "#f4f5f4"
color_black = "#101010"
...
def register_capture():
    cap = cv2.VideoCapture(1) #camara de registro
...
def login_capture():
    cap = cv2.VideoCapture(1) #camara de login
